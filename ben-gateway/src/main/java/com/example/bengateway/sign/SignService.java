package com.example.bengateway.sign;
...
import com.example.bengateway.utils.SignUtil;
...
public class SignService {
     ...
     */
    public boolean validateSign(String appId, String timestamp, String token, String requestBody) {
        return true;
        /*//获取appId对应的secret
        String appSecret = getAppSecret(appId);

        //校验签名
        return SignUtil.validateSign(appId, appSecret, timestamp, requestBody, token);
    */
    }
